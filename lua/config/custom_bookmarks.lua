...
function M.next_global_bookmark()
    ...
    if next_bookmark then
      ...
      vim.notify("Saltando al primer marcador: " .. first_bookmark.filename .. ":" .. first_bookmark.line, vim.log.levels.INFO)
    end
  end
  ...
  function prev_global_bookmark()
    ...
    if prev_bookmark then
      ...
      vim.notify("Saltando al marcador anterior: " .. prev_bookmark.filename .. ":" .. prev_bookmark.line, vim.log.levels.INFO)
    else
      ...
      vim.notify("Saltando al último marcador: " .. last_bookmark.filename .. ":" .. last_bookmark.line, vim.log.levels.INFO)
    end
  end
return M
